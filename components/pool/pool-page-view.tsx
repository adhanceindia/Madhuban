...
import { defaultPoolBlocks } from '@/lib/default-blocks'

type PoolPageViewProps = {
  siteContent: SiteContent
  pageData?: Record<string, unknown>
}

export function PoolPageView({ siteContent: initialSiteContent, pageData: initialPageData }: PoolPageViewProps) {
  ...
  const blocks = (pageData.page_blocks as any[]) || defaultPoolBlocks
